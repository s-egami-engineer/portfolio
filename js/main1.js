...
const menuTrigger1 = menuBtn.getElementsByClassName('menu-trigger1');
const menuTrigger2 = menuBtn.getElementsByClassName('menu-trigger2');
const menuTrigger3 = menuBtn.getElementsByClassName('menu-trigger3');
const menuList = document.getElementsByClassName('menu-list');

console.log(menuList[0]);
menuBtn.addEventListener('click', () => {
  menuTrigger1[0].classList.toggle('transform');
  menuTrigger2[0].classList.toggle('transform');
  menuTrigger3[0].classList.toggle('transform');
  // menuList[0].classList.toggle('close');
  menuList[0].slideToggle(400);
